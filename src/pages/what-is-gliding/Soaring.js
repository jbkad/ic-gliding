           ...
           <div className="card">
                <div className="container">
                    <img
                        ...
                        className="img"
                    />
                    <div className="caption">Thermals</div>
                </div>
            </div> 
            <div className="card">
                <div className="container">
                    <img
                        ...
                        className="img"
                    />
                    <div className="caption">Ridge lifts</div>
                </div>
            </div> 
            <div className="card">
                <div className="container">
                    <img
                        ...
                        className="img"
                    />
                    <div className="caption">Wave dynamics</div>
                </div>
            </div> 
            <div className="caption">The three main glider ascents.</div>
