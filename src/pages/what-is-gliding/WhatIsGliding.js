...
export default function WhatIsGliding() {
  return (
    <div className="what-is-gliding">
      ...
      <p>
        Winch launching the primary method of the launch used during training as
        it is a low cost and rapid method of launch.
      </p>
      <div className="card">
        <div className="container">
          ...
          <p>
            ...
            will climb upwards at around 45° similar to a kite on a string. Once
            at flying altitude the cable will be released from the glider and
            the glider is free to fly around. The height achieved by a winch
            launch is dependent on the weather conditions and the length of the
            runway used to launch.
          </p>
        </div>
      </div>
      <h2 className="subheading">Aerotow launching</h2>
      <p>Aerotow launching is another method of launching gliders.</p>
      <div className="card">
        <div className="container">
          <Aerotow />
          <p>
            ...
            launch method is much more expensive and takes a lot longer to climb
            to the desired altitude however it gives more flexibility than a
            winch launch as the tow plane could climb as high as you could
            reasonably want.
          </p>
        </div>
      </div>
